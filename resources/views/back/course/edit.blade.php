@extends('back.layout.layout', [$title = 'Edit the course']);
...
<div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title" id="basic-layout-square-controls">Edit the course</h4>
          ...
          <form class="form" action="{{route('course.update', $course->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-body">
              ...
              <fieldset class="form-group">
                ...
                <textarea id="title" rows="5" class="form-control" name="title" placeholder="Title">{{ $course->title }}</textarea>
                @if($errors->has('title'))
              ...
              <div class="form-group">
                ...
                <input value="{{$course->duration}}" type="text" id="duration" class="form-control square {{ $errors->has('duration') ? 'is-invalid' : ''}} " placeholder="Duration" name="duration">
              ...
              <div class="form-group">
                ...
                <input value="{{$course->technologies}}" type="text" id="technologies" class="form-control square {{ $errors->has('technologies') ? 'is-invalid' : ''}} " placeholder="Technologies" name="technologies">
              ...
              <div class="form-group">
                ...
                <input value="{{$course->student_level}}" type="text" id="student_level" class="form-control square {{ $errors->has('student_level') ? 'is-invalid' : ''}} " placeholder="Student Lavel" name="student_level">
              ...
              <div class="form-group">
                ...
                <input value="{{$course->requirement}}" type="text" id="requirement" class="form-control square {{ $errors->has('requirement') ? 'is-invalid' : ''}} " placeholder="Requirement" name="requirement">
              ...
              <fieldset class="form-group">
                ...
                <textarea id="meta" rows="5" class="form-control" name="meta" placeholder="Meta">{{ $course->meta }}</textarea>
                @if($errors->has('meta'))
